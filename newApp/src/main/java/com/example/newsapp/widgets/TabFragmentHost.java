        ...
        if (mLastTab != newTab) {
            ...
            if (mLastTab != null) {
                if (mLastTab.fragment != null) {
                    // detach is removed from the UI
                    // hide is Hides an existing fragment
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    // attach is Re-attach a fragment after it had previously been deatched fromthe UI
                    // show is to shows a previously hidden fragment
